...
const ChatHeader = ({ selectedChat, onOpenSidebar, onDeleteChat, isDeleting, onShowGroupInfo, onCloseChat }) => {
  ...
  return (
    <div className="p-3 border-b border-gray-200 bg-white">
      <div className="flex items-center space-x-3">
        ...
        <button
          onClick={onCloseChat}
          className="p-2 rounded-lg hover:bg-gray-100 text-gray-500 hover:text-gray-700 transition-colors ml-2"
